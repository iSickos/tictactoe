...
function MultiButton() {
    ...
    return (
        ...
        <motion.button className=" space-x-10 select-none w-64 h-16 flex items-center justify-center data-[ison='true']:space-x-3 rounded-[50px] shadow-[10, rgba(0, 0, 0, 0.05)] shadow"
            data-ison={isOn}
